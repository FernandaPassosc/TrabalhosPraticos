...
{
   Personagem tabela[];
   int tamanhoTab, tamanhoRes, tamanhoTotal, qnt_reserva;
   ...
   public Hash (int tamanhoTab, int tamanhoRes)
   {
      this.tamanhoTab = tamanhoTab;
      this.tamanhoRes = tamanhoRes;
      this.tamanhoTotal = tamanhoTab + tamanhoRes;

      this.tabela = new Personagem [this.tamanhoTotal];
   ...
   {
      return elemento.getaltura() % tamanhoTab;
   }
   ...
   public boolean inserir(Personagem elemento)
   {
      ...
      if(!elemento.getnome().equals("nulo"))
      {
         ...
         else if (qnt_reserva < tamanhoRes)
         {
            tabela[tamanhoTab + qnt_reserva] = elemento.Clone();
            qnt_reserva++;
            resp = true;
         }
      }
